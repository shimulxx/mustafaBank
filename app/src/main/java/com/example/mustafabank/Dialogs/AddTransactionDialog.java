...
import com.example.mustafabank.AddInvestmentActivity;
import com.example.mustafabank.AddLoanActivity;
import com.example.mustafabank.R;
import com.example.mustafabank.ShoppingActivity;
import com.example.mustafabank.TransferActivity;
...
public class AddTransactionDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        shopping = (RelativeLayout)view.findViewById(R.id.shoppingRelLayout);
        ...
        transaction = (RelativeLayout) view.findViewById(R.id.sendOrReceiveRelLayout);
